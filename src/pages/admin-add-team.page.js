          ...
          {isLoading ? (
            ...
            <div className="admin-form">
              ...
              <div class="form-group">
                <label className="admin-label" for="name">
                  Name
                </label>
                <input
                  type="email"
              ...
              {/* second input */}
              <div class="form-group">
                <label className="admin-label" for="designation">
                  Designation
                </label>
              ...
              {/* third input */}
              <div class="form-group">
                <label className="admin-label" for="description">
                  Description
                </label>
                <textarea
              ...
              {/* FIFTH INPUT */}
              <div class="form-group">
                <label className="admin-label mr-4" for="desc">
                  Choose Picture
                </label>
                <input
                ...
                <small className="ml-3 font-weight-bold">
                  {teamImage ? teamImage.name : ""}
                </small>
              </div>
              {/* Button */}
              <Button
                ...
                size="large"
                variant="contained"
                className="btn-block admin-block-btn"
              >
                Add Team
              </Button>
            </div>
